    ...
    <form @submit.prevent="formSubmit" class="form">
        <div class="field-container">
            ...
            <div class="input-has-label">
                <input type="text" name="name" placeholder="Holder" id="name" class="input-field" v-model="name" />
        ...
        <div class="field-container">
            ...
            <div class="input-has-label">
                <input type="email" name="email" placeholder="holder@holder.com" id="email" class="input-field" v-model="email" />
                <span class="field-icon-container">
                    <svg viewBox="0 0 24 24" class="field-icon">
        ...
        <div class="field-container">
            ...
            <div class="input-has-label">
                <input type="password" name="password" placeholder="********" id="password" class="input-field" v-model="password" />
                <span class="field-icon-container">
                    <svg viewBox="0 0 24 24" class="field-icon">
        ...
        <div class="field-container">
            ...
            <div class="input-has-label">
                <input type="password" name="password_confirmation" placeholder="********" id="confirm-password" class="input-field" v-model="passwordConfirmation" />
                <span class="field-icon-container">
                    <svg viewBox="0 0 24 24" class="field-icon">
        ...
        <div class="field-container">
            <button type="submit" class="button button-submit" v-bind:disabled="submitButtonIsDisabled">CADASTRAR MINHA CONTA</button>
        </div>

        <div class="field-container">
            <a href="{{ route('login') }}" class="link is-justify-content-center">Acessar minha conta</a>
        </div>
    </form>
@endsection
