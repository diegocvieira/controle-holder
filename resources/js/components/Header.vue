    ...
    <header id="header">
        ...
        <div id="mobile-menu" v-if="isOpen">
            <ul>
                ...
                <li>
                    <router-link :to="{ name: 'targetAssetClasses' }" :class="{'is-active': $route.meta.menuSection === 'target-asset-classes'}" @click="toggleMenu()">Meta de classes de ativos</router-link>
                </li>

                <li>
                    <router-link :to="{ name: 'targetAsset' }" :class="{'is-active': $route.meta.menuSection === 'target-assets'}" @click="toggleMenu()">Meta de ativos</router-link>
                </li>
                ...
                <li>
                    <a href="#" :class="{'is-active': $route.meta.menuSection === 'help'}">Ajuda</a>
                </li>
